...
import { Crown, MapPin, Heart, MessageSquare, Star, Calendar, ShoppingBag, Gift } from 'lucide-react';
          ...
          <CardContent className="pt-6">
            <div className="flex items-center space-x-6">
              ...
              <div className="flex-1">
                ...
                <p className="text-gray-600 mb-4">加入于 {userStats.joinDate}</p>
              ...
              <div className="text-right">
                ...
                <Button className="gradient-ocean text-white block w-full">升级会员</Button>
              </div>
            </div>
          </CardContent>
        </Card>
